...
// customized cout
		...
		std::cout << "fx_init ... " << fx_init << std::endl;
		std::cout << "step ... " << step << std::endl;
		std::cout << "test_decr ... " << test_decr << std::endl;
		std::cout << "abs(dg) ... " << std::abs(dg) << std::endl;
		std::cout << "test_curv ... " << test_curv << std::endl;
//////////////////////////
/////////////////////////
// customized terminiation criteria
        Scalar fx_pre = fx;
/////////////////////////
        // Convergence test
      ...
      if(abs(fx-fx_pre) < 1.0e-5)
      {
        return;
      }
	    if(abs(fx-fx_init) < 1.0e-7)
	      {
		        return;
	      }
