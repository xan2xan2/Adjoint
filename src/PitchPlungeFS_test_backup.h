...
/*
		...
		double y = _plungeAmp * sin(1. / 1.  * time / _Tp + _plungePhase) * 0.;
		 ...
		 double theta = theta0 + theta1 + theta2 + theta3 + theta4;
		 double thetadot = thetadot0 + thetadot1 + thetadot2 + thetadot3 +thetadot4;
   ...
   //  cout << "Tp..." << _Tp << endl;
	...
	//cout << " time Fun... " << time << endl;
		 ...
		 cout << "pitchAmp0..." << _pitchAmp0 << endl;
		  cout << "pitchAmp1..." << _pitchAmp1 << endl;
			 cout << "pitchAmp2..." << _pitchAmp2 << endl;
			  cout << "pitchAmp3..." << _pitchAmp3 << endl;
				 cout << "pitchAmp4..." << _pitchAmp4 << endl;
