...
public:
    ...
    bool doOutput(const double alpha, const double theta, const double mag, const State& x, const double zM);
    ...
    /////////////////////
    bool doOutput(const double theta, const BaseFlow& q, const State& x, const double zM);
    ////////////////////
